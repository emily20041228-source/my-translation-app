...
def get_ai_model(instruction=""):
    ...
    try:
        return genai.GenerativeModel('gemini-2.5-flash', system_instruction=final_instruction)
    except:
        return genai.GenerativeModel('gemini-2.5-pro', system_instruction=final_instruction)
